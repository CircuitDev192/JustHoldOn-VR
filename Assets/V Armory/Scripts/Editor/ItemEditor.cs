...
[CustomEditor(typeof(BladeLegacy))]
public class BladeEditor : ItemEditor
{
    public override void OnInspectorGUI()
    {
        base.OnInspectorGUI();
...
[CustomEditor(typeof(Taclight))]
public class TaclightEditor : AttachmentEditor
{
    public override void OnInspectorGUI()
    {
        base.OnInspectorGUI();
...
[CustomEditor(typeof(Lasersight))]
public class LasersightEditor : AttachmentEditor
{
    public override void OnInspectorGUI()
    {
        base.OnInspectorGUI();
...
[CustomEditor(typeof(TaclightLasersightCombo))]
public class TaclightLasersightComboEditor : AttachmentEditor
{
    public override void OnInspectorGUI()
    {
        base.OnInspectorGUI();
...
public class SightEditor : AttachmentEditor
{
    public override void OnInspectorGUI()
    {
        base.OnInspectorGUI();
...
[CustomEditor(typeof(MagnifiedScope))]
public class MagnifiedScopeEditor : AttachmentEditor
{
    public override void OnInspectorGUI()
    {
        base.OnInspectorGUI();
...
[CustomEditor(typeof(RPG))]
public class RPGEditor : FirearmEditor
{
    public override void OnInspectorGUI()
    {
        base.OnInspectorGUI();
...
[CustomEditor(typeof(RotatingBoltSMG))]
public class RotatingBoltSMGEditor : FirearmEditor
{
    public override void OnInspectorGUI()
    {
        base.OnInspectorGUI();
...
public class ShotgunEditor : FirearmEditor
{
    public override void OnInspectorGUI()
    {
        base.OnInspectorGUI();
...
[CustomEditor(typeof(PumpAction))]
public class PumpActionEditor : ShotgunEditor
{
    public override void OnInspectorGUI()
    {
        base.OnInspectorGUI();
