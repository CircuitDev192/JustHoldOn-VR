...
namespace VArmory
{
    public class Item : MonoBehaviour
    {
        ...
        */
        ...
        public bool LocalInput(VArmoryInput.LocalInputEvent localInputEvent, SteamVR_Action_Boolean button) { return VArmoryInput.Input(localInputEvent, button, PrimaryHand); }

        public bool LocalInputDown(VArmoryInput.LocalInputEvent localInputEvent, SteamVR_Action_Boolean button) { return VArmoryInput.InputDown(localInputEvent, button, PrimaryHand); }

        public bool LocalInputUp(VArmoryInput.LocalInputEvent localInputEvent, SteamVR_Action_Boolean button) { return VArmoryInput.InputUp(localInputEvent, button, PrimaryHand); }

        public bool TouchPadInput(VArmoryInput.LocalInputEvent touchpadEvent, VArmoryInput.TouchPadDirection direction) { return VArmoryInput.TouchPadInput(touchpadEvent, direction, PrimaryHand); }
