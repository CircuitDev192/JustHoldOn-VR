...
namespace VArmory
{
    public class VirtualStock : MonoBehaviour
    {
        ...
        public bool Shouldered { get { return shouldered; } }

        bool shouldered;

        protected float stockOffset;

        public float StockOffset { get { return stockOffset; } }

        public Vector3 ShoulderPosition
        {
            get { return head.TransformPoint(shoulderOffset); }
        }
        ...
        [SerializeField] protected float shoulderWeaponDistance; //How close does the primary hand need to be to the shoulder to enable the VS?
